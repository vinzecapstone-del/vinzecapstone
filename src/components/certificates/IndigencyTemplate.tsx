...
// Displays the captain's signature image
function ESignature() {
  return (
...
export default function IndigencyTemplate({ data }: Props) {
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ lineHeight: '2', fontSize: '13px', textAlign: 'justify', marginBottom: '20px' }}>
          <p>
            ...
            belongs to an <strong>INDIGENT FAMILY</strong> and is one of the underprivileged
        ...
        <div style={{ lineHeight: '2', fontSize: '13px', textAlign: 'justify', marginBottom: '20px' }}>
          <p>
            The above-named person and his/her family do not have sufficient means to support
            their basic needs and are considered part of the{' '}
            <strong>low-income sector</strong> of our community.
          </p>
        </div>
